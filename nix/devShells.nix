rec {
  shellHook-for = { package, pythoneda-base, python, nixpkgsRelease }: ''
    ...
    echo -e " \033[32m| '_ \| | | | __| '_ \ / _ \| '_ \ \033[34m/ _ \\\\\033[35m/ _\` |\033[36m/ _\` |\033[33mhttps://github.com/pythoneda-artifact-infrastructure/git-tagging/tree/$PVERSION\033[0m";
    ...
    echo -e " \033[32m|_| \033[31mI\033[36mA\033[32m |___/             \033[33mGIT-TAGGING                \033[37mhttps://patreon.com/rydnr\033[0m";
    echo;
